...
%PLOTRESPONSE 
%-------------------------------Description-------------------------------%
% Plots the responses of each reference neuron in relation to the input
% line orientation and shows the angle of the maximum response
%
%--------------------------------Function---------------------------------%
    ...
    fig = figure('Name', 'Reference Neurons Tuning Curves');
    ...
    for referenceIndex = 1 : nReferences
        ...
        title(ax, 'Reference Neurons Tuning Curves');
        hold off
    end
end
